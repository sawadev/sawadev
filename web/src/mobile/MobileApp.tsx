    ...
    <div style={{ height: '100%', display: 'flex', flexDirection: 'column', background: 'var(--bg)' }}>
      ...
      <div style={{ flex: 1, minHeight: 0, overflowY: 'auto', padding: '0 18px 24px' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', marginBottom: 12 }}>
          <span style={{ fontSize: 13, fontWeight: 700, color: 'var(--text-2)', letterSpacing: 0.2 }}>WORKSPACES</span>
        </div>
      ...
      <div style={{ position: 'absolute', right: 18, bottom: BOTPAD + 14 }}>
        <button className="btn btn-primary" style={{ height: 52, borderRadius: 26, padding: '0 22px', boxShadow: '0 8px 24px var(--accent-soft), 0 2px 6px rgba(0,0,0,.25)' }}>
