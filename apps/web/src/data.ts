...
export const SEED_MSGS: Msg[] = [
  ...
  {
    role: 'agent',
    text: "I'll add a middleware that verifies the bearer token, then apply it to the orders router.",
  },
  {
    role: 'tool',
    kind: 'cmd',
  ...
  {
    role: 'agent',
    text: 'Done — the orders routes now reject requests without a valid token. 14 tests pass.',
  },
];
  ...
  return [
    {
      ...
      msg: {
        role: 'agent',
        text: "Got it — I'll plan the change, edit the relevant files, then run the tests.",
      },
    },
    {
      delay: 1100,
    ...
    },
    {
      ...
      msg: {
        role: 'agent',
        muted: true,
        text: 'All green — 18 tests passing. Want me to open a pull request?',
      },
    },
  ];
}
