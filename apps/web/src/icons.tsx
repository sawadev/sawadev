...
export const HICONS: Record<string, string> = {
  ...
  branch:
    'M5 2.6v10.8 M5 5.4a2 2 0 100-4 2 2 0 000 4z M5 14.4a2 2 0 100-4 2 2 0 000 4z M12 6.9a2 2 0 100-4 2 2 0 000 4z M12 4.9c0 3.6-4.5 3.6-7 4',
  ...
  attach:
    'M13 7.4l-5.4 5.4a2.9 2.9 0 01-4.3-3.9l5.9-5.9a1.9 1.9 0 012.9 2.9l-5.9 5.9a1 1 0 01-1.5-1.5l5.4-5.4',
  ...
  command:
    'M5 5a1.8 1.8 0 110-3.6A1.8 1.8 0 016.8 3.2v9.6A1.8 1.8 0 1111 11h-.2M11 5a1.8 1.8 0 100-3.6A1.8 1.8 0 009.2 3.2v9.6A1.8 1.8 0 105 11h.2',
